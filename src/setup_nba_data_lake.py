...
bucket_name = "izudavo3-sports-analytics-data-lake"  # Change to a unique S3 bucket name
...
nba_endpoint = os.getenv("NBA_ENDPOINT")  # Load NBA endpoint from .env

if not api_key or not nba_endpoint:
    print("Error: API_KEY or NBA_ENDPOINT is missing in the .env file.")
    exit(1)
